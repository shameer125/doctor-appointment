...
const SignupPage = () => {
    ...
    useEffect(() => {
        if (bootstrapped && isAuthenticated) {
            history.replace(afterSignup);
        }
    }, [afterSignup, bootstrapped, history, isAuthenticated]);
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            if (!res.ok) {
                setApiError(res.error || "Could not continue.");
                return;
            }
            setFlash("Account ready. You’re signed in.");
            window.setTimeout(() => {
    ...
    return (
        <React.Fragment>
            <Layout>
                <SEO title="Sign up | Hope Medical" />
                            ...
                            <div className="container">
                                <div className="auth-page-card">
                                    ...
                                    <p className="auth-page-lead">
                                        Use your email to sign in for this demo
                                        (no password).
                                    </p>
                                    {flash ? (
                                        <div
