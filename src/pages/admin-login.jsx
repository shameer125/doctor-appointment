                ...
                <div style={styles.card}>
                    ...
                    <div style={styles.hint}>
                        <i
                            ...
                            style={{ color: "#9b1f1f", marginRight: "0.4rem" }}
                        />
...
const styles = {
    page: {
        minHeight: "100vh",
        background:
            "linear-gradient(135deg, #080e1c 0%, #1a0a0a 50%, #0c1424 100%)",
        display: "flex",
        alignItems: "center",
    ...
    circle1: {
        ...
        height: "400px",
        borderRadius: "50%",
        background: "rgba(155,31,31,0.12)",
        pointerEvents: "none",
    },
    circle2: {
        position: "absolute",
